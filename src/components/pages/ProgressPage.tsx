    ...
    <div className="container mx-auto px-4 py-8 lg:py-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        ...
        <Card>
          <CardHeader className="pb-3">
            ...
            <CardTitle className="text-primary">{skillProgress.length}</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="flex items-center gap-2 text-muted-foreground">
              <BookOpen className="h-4 w-4" />
              <span>
                {/* Média simples de progresso */}
                {Math.round(skillProgress.reduce((acc, s) => acc + s.level, 0) / skillProgress.length) || 0}
                % progresso médio
              </span>
            </div>
          </CardContent>
        ...
        <Card>
          <CardHeader className="pb-3">
            ...
            <CardTitle className="text-primary">{monthlyProgress.reduce((acc, m) => acc + m.completed, 0)}</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="flex items-center gap-2 text-muted-foreground">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Últimos 7 dias de dedicação</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Progresso mensal de conclusão</CardDescription>
          </CardHeader>
          <CardContent>
            <ResponsiveContainer width="100%" height={250}>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Seu progresso em diferentes áreas de conhecimento</CardDescription>
        </CardHeader>
        <CardContent>
